            ...
            return (
              <div>
                ...
                >
                  <button
                    style={{
                      backgroundColor: actions.bold.isActive()
                        ? "white"
                        : "pink",
                  ...
                  <button
                    style={{
                      backgroundColor: actions.italic.isActive()
                        ? "white"
                        : "pink",
                  ...
                  <button
                    style={{
                      backgroundColor: actions.underline.isActive()
                        ? "white"
                        : "pink",
...
export const DocumentModelEditor: FunctionComponent<RemirrorProps> = () => (
  <EditorLayout />
);
export const BasicRendererReact: FunctionComponent = () => (
  <RenderTree json={initialJson} />
);
